jQuery(document).ready(function($) {
    ...
    $('#vrt-test-sitemap').on('click', function(e) {
        e.preventDefault();
        ...
        const formData = {
            action: 'vrt_test_connection',
            nonce: vrtSingleTestData.nonce,
            reference_url: $form.find('#site-audit-reference-sitemap').val(),
            test_url: $form.find('#site-audit-test-sitemap').val(),
            reference_auth_username: $form.find('#site-audit-reference-auth-username').val(),
            reference_auth_password: $form.find('#site-audit-reference-auth-password').val(),
            test_auth_username: $form.find('#site-audit-test-auth-username').val(),
            test_auth_password: $form.find('#site-audit-test-auth-password').val()
        };
    ...
    $('#vrt-single-test-form').on('submit', function(e) {
        ...
        console.log(vrtSingleTestData);
        
        // Get form data
        const formData = {
            action: 'vrt_wdm_run_single_test',
            nonce: vrtSingleTestData.nonce,
            reference_url: $form.find('#single-test-reference-url').val(),
            test_url: $form.find('#single-test-test-url').val(),
            reference_auth_username: $form.find('#single-test-reference-auth-username').val(),
